export const perguntas = [
    {
        enunciado: "Assim que terminou o ensino médio você se depara com uma nova tecnologia, um chat que consegue responder todas as dúvidas que uma pessoa pode ter, ele também gera imagens e áudios hiper-realistas. Qual o primeiro pensamento?",
        alternativas: [
            {
            ...
            {
                texto: "Posso trabalhar com mais eficiência.",
                afirmacao: [
